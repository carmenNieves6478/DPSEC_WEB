...
const latestActivities = [
    {
        id: 1,
        title: 'Campaña Regional de Reforestación y Conservación de Suelos',
        category: 'Proyección Social',
        date: '12 de Octubre, 2026',
        location: 'Huata, Puno',
        description: 'Estudiantes y docentes de la UNA Puno se movilizan para la plantación de más de 5,000 queñuas y pinos en zonas altoandinas vulnerables.',
        image: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3', // High quality placeholder representing nature/planting
        tagColor: 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400'
    },
    {
        id: 2,
        title: 'Festival Universitario de Danzas Autóctonas y Trajes de Luces',
        category: 'Extensión Cultural',
        date: '04 de Noviembre, 2026',
        location: 'Estadio Monumental UNA',
        description: 'Celebrando la identidad cultural del Altiplano con la participación de las 35 escuelas profesionales en danzas autóctonas y trajes tradicionales.',
        image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3', // Represents cultural festival
        tagColor: 'bg-amber-500/10 text-amber-600 dark:text-amber-400'
    },
    {
        id: 3,
        title: 'Taller de Emprendimiento y Asesoría Contable en Comunidades Rurales',
        category: 'Proyección Social',
        date: '28 de Noviembre, 2026',
        location: 'Acora, Puno',
        description: 'Capacitación a productores locales de quinua y artesanos sobre formalización de microempresas y gestión financiera básica.',
        image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3', // Represents teaching/business support
...
const slides = [
    'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=1600&auto=format&fit=crop&q=80', // Eco-UNA
    'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1600&auto=format&fit=crop&q=80', // Cine Universitario
    'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1600&auto=format&fit=crop&q=80'  // Rescate Titicaca
];
...
<template>
    <PublicLayout title="Inicio">
        <section class="relative h-[calc(100vh-96px)] min-h-[500px] flex items-center overflow-hidden bg-neutral-950 text-white">
            ...
            <div class="absolute inset-0 z-0">
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-black/90 via-black/70 to-transparent dark:from-black/95 dark:via-black/80 dark:to-transparent z-10"></div>
            </div>

            <!-- Content Area -->
            <div class="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-20">
                <div class="max-w-3xl space-y-6 text-left">
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/20 text-indigo-300 text-xs font-semibold uppercase tracking-wider border border-indigo-500/30">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1] text-white">
                        Conectando la <span class="bg-gradient-to-r from-indigo-400 via-blue-400 to-indigo-300 bg-clip-text text-transparent">Universidad</span> con nuestra Sociedad
                    </h1>
                    
                    <p class="text-lg text-neutral-300 leading-relaxed max-w-2xl">
                        La Dirección de Proyección Social y Extensión Cultural de la UNA Puno lidera programas integradores, voluntariados, preservación del patrimonio cultural altiplánico y proyectos sostenibles para el desarrollo regional.
                    </p>
                    
                    <div class="flex flex-wrap gap-4 pt-2">
                        <Link href="/proyeccion-social">
                            <Button class="rounded-xl h-12 px-6 bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-600/25 transition-all font-semibold flex items-center gap-2 cursor-pointer border-0">
                                Ver Actividades
                                <ArrowRight class="size-4" />
                            </Button>
                        </Link>
                        <Link href="/documentos">
                            <Button variant="outline" class="rounded-xl h-12 px-6 border-white/20 bg-white/5 text-white hover:bg-white/10 font-semibold flex items-center gap-2 cursor-pointer">
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8 space-y-12">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div class="space-y-3 text-left">
                        <span class="text-xs font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400">Noticias y Publicaciones</span>
                        ...
                        <p class="text-neutral-500 dark:text-neutral-400 max-w-xl text-sm md:text-base">
                            Mantente al día con los últimos eventos, campañas de voluntariado y proyectos de proyección social publicados en nuestros canales oficiales.
                        </p>
                    </div>
                    <Link href="/eventos">
                        <Button variant="ghost" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-semibold group flex items-center gap-1 cursor-pointer">
        ...
        <section class="reveal-section py-20 bg-neutral-50/50 dark:bg-neutral-900/10 border-t border-neutral-200/50 dark:border-neutral-800/30">
            <div class="max-w-7xl mx-auto px-6 lg:px-8 space-y-12">
                <div class="text-center max-w-2xl mx-auto space-y-3">
                    <span class="text-xs font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400">Directorio de SubUnidades</span>
                    <h2 class="text-3xl font-extrabold tracking-tight">Accede a Nuestras Áreas</h2>
                    <p class="text-neutral-500 dark:text-neutral-400 text-sm">
                        Conoce las dependencias que forman parte de la Dirección de Proyección Social y Extensión Cultural.
                    </p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <!-- Card 1: Proyección Social -->
                    <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 bg-white dark:bg-neutral-900/60 shadow-xs space-y-5 text-left flex flex-col h-full justify-between">
                        <div class="space-y-4">
                            <div class="size-12 rounded-xl bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 flex items-center justify-center">
                                <Award class="size-6" />
                            </div>
                            <h3 class="text-xl font-bold text-neutral-950 dark:text-white">Proyección Social y Extensión Cultural</h3>
                            <p class="text-sm text-neutral-600 dark:text-neutral-300 leading-relaxed">
                                Foco principal de gestión. Coordina y aprueba proyectos sociales, prácticas en comunidades y eventos culturales impulsados por las facultades.
                            </p>
                        </div>
                        <Link href="/proyeccion-social" class="pt-4 block">
                            <Button class="w-full rounded-xl bg-neutral-950 hover:bg-neutral-900 dark:bg-white dark:text-neutral-950 dark:hover:bg-neutral-100 flex items-center justify-center gap-2 cursor-pointer">
                                Ver Actividades
                                <ArrowRight class="size-4" />
                            </Button>
                        </Link>
                    ...
                    <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 bg-white dark:bg-neutral-900/60 shadow-xs space-y-5 text-left flex flex-col h-full justify-between">
                        <div class="space-y-4">
                            <div class="size-12 rounded-xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center">
                                <Leaf class="size-6" />
                            </div>
                            <h3 class="text-xl font-bold text-neutral-950 dark:text-white">Gestión Ambiental</h3>
                            <p class="text-sm text-neutral-600 dark:text-neutral-300 leading-relaxed">
                                Área dedicada a la conservación ecológica de la Ciudad Universitaria, voluntariados de segregación de residuos y educación ambiental.
                            </p>
                        </div>
                        <a href="https://www.unap.edu.pe" target="_blank" rel="noopener noreferrer" class="pt-4 block">
                            <Button variant="outline" class="w-full rounded-xl flex items-center justify-center gap-2 border-neutral-300 dark:border-neutral-700 cursor-pointer">
                                Visitar Sitio Web
                    ...
                    <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 bg-white dark:bg-neutral-900/60 shadow-xs space-y-5 text-left flex flex-col h-full justify-between opacity-85 hover:opacity-100 transition-opacity">
                        <div class="space-y-4">
                            <div class="size-12 rounded-xl bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center">
                                <Users class="size-6" />
                            </div>
                            <div class="flex items-center justify-between">
                                <h3 class="text-xl font-bold text-neutral-950 dark:text-white">Seguimiento al Graduado</h3>
                                <span class="text-[9px] bg-amber-500/10 text-amber-600 dark:text-amber-400 px-2 py-0.5 rounded font-bold uppercase tracking-wider shrink-0">Próximamente</span>
                            </div>
                            <p class="text-sm text-neutral-600 dark:text-neutral-300 leading-relaxed">
                                Plataforma futura de inserción laboral, encuestas de egresados y contacto con las redes de exalumnos de la UNA Puno.
                            </p>
                        </div>
        ...
        <section class="reveal-section py-20">
            <div class="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-5 space-y-6 text-left">
                    <span class="text-xs font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400">Transparencia y Normas</span>
                    ...
                    <p class="text-neutral-600 dark:text-neutral-300 text-sm md:text-base leading-relaxed">
                        Descarga las resoluciones, directivas vigentes, reglamentos y guías metodológicas para registrar tus proyectos de proyección social y extensión cultural adecuadamente.
                    </p>
                    <Link href="/documentos">
                        <Button class="rounded-xl bg-indigo-700 hover:bg-indigo-800 text-white flex items-center gap-2 cursor-pointer">
                    ...
                    >
                        <div class="space-y-1">
                            <div class="flex items-center gap-2">
                                <span class="text-[9px] bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 px-1.5 py-0.5 rounded font-bold uppercase tracking-wider">{{ doc.type }}</span>
                                <span class="text-[10px] text-neutral-400 font-mono">{{ doc.code }}</span>
                            </div>
                            <h4 class="font-bold text-sm text-neutral-900 dark:text-white line-clamp-1">{{ doc.title }}</h4>
                            <p class="text-xs text-neutral-400">Publicado: {{ doc.date }}</p>
                        </div>
                        <Link href="/documentos">
                            <Button size="sm" variant="outline" class="rounded-xl flex items-center gap-1.5 text-xs border-neutral-300 dark:border-neutral-700 shrink-0 self-start sm:self-auto cursor-pointer">
        ...
        <section class="reveal-section py-12 border-y border-neutral-200/55 dark:border-neutral-800/40 bg-neutral-50/50 dark:bg-neutral-900/10">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    >
                        ...
                        <div class="space-y-1">
                            <span class="text-3xl font-extrabold text-neutral-900 dark:text-white tracking-tight">{{ stat.value }}</span>
                            <h3 class="text-sm font-semibold text-neutral-800 dark:text-neutral-200">{{ stat.label }}</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 w-full h-full">
                        ...
                        <div class="md:col-span-5 relative h-[180px] sm:h-[220px] md:h-full overflow-hidden bg-neutral-100 dark:bg-neutral-950 shrink-0">
                            ...
                            <div class="absolute top-4 left-4 flex gap-1.5 flex-wrap">
                                <span class="text-[9px] font-bold uppercase tracking-wider px-2.5 py-1 rounded bg-indigo-600 text-white shadow-md" :class="selectedActivity.tagColor">
                        ...
                        <div class="md:col-span-7 p-6 md:p-8 flex flex-col justify-between h-full overflow-y-auto max-h-[calc(90vh-180px)] sm:max-h-[calc(90vh-220px)] md:max-h-full">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-[9px] font-bold uppercase tracking-wider px-2.5 py-1 rounded" :class="selectedActivity.tagColor">
                                        {{ selectedActivity.category }}
                                    </span>
                                ...
                                <div class="space-y-1.5">
                                    <h4 class="text-[10px] font-bold text-neutral-400 uppercase tracking-wider">Detalles</h4>
        ...
        <div 
            class="fixed left-4 top-1/2 -translate-y-1/2 z-50 hidden sm:flex flex-col gap-4 transition-all duration-500 ease-in-out"
            :class="showFloatingBar ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-16 pointer-events-none'"
        >
            <div class="flex flex-col items-center pb-3 bg-white/70 dark:bg-neutral-950/70 backdrop-blur-md rounded-2xl border border-neutral-200/50 dark:border-neutral-800/50 shadow-lg w-14">
                <!-- Header Facebook Indicator (Takes the top shape of the bar) -->
                <div class="w-full h-10 flex items-center justify-center bg-[#1877f2] text-white shrink-0 mb-3 rounded-t-2xl" title="Páginas de Facebook Oficiales">
